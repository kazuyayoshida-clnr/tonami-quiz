...
export default function CertificateContent() {
  ...
  useEffect(() => {
    ...
    if (url) {
      setQrUrl(`https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=${encodeURIComponent(url)}&color=3B1F0A&bgcolor=F5EFE0`);
    }
  }, []);
  ...
  return (
    <div style={{
      ...
      <div className="cert-card" style={{
        ...
        {isPerfect && (
          <div style={{
            ...
            color: "#3B1F0A", fontSize: 13, fontWeight: 700,
        ...
        <h1 style={{
          ...
          color: "#3B1F0A", margin: "0 0 16px", letterSpacing: "0.2em",
          borderBottom: "1.5px solid #C8A96E", paddingBottom: 12,
        }}>
          受講証明書
        </h1>
        ...
        {/* 日付 */}
        <p style={{ textAlign:"right", fontSize:13, color:"#6B4226", margin:"0 0 16px" }}>
          {today}
        </p>
      ...
      <a href="/" style={{
        ...
        border: "1.5px solid #C8A96E", borderRadius: 50,
